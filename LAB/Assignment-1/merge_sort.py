...
def mergesort(arr) :
    ...
    mergesort(left)	# To make progress towards the desired result
    mergesort(right)	# To make progress towards the desired result

    merge(left,right,arr)	# To make progress towards the desired result
