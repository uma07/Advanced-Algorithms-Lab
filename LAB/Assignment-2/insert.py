...
# Loop Invariant : At the end of 'while loop', all the elements in List[limit, ... ,n] are sorted in ascending order
# Boundary Condition : n = 0 and n = 1
# Exception Condition : n is -ve
# Alternative : 
# Normal :
